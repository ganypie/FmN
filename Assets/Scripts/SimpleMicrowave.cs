...
public class SimpleMicrowave : MonoBehaviour, IInteractable
{
    ...
    [Tooltip("Направление открытия: true = положительное (вправо), false = отрицательное (влево)")]
    ...
    private void ToggleDoor(Transform interactor)
    {
        ...
        if (isOpen)
        {
            ...
            // Вращаем по оси Z
            targetRot = closedRot * Quaternion.Euler(0f, 0f, angle);
